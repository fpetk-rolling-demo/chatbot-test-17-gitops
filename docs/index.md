...
The AI Software Template that was executed comes with a sample application. This application will be built from https://github.com/fpetk-rolling-demo/chatbot-test-17, stored in [quay.io/tpetkos/chatbot-test-17](https://quay.io/tpetkos/chatbot-test-17) and deployed through ArgoCD. 
